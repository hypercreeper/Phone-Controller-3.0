...
using Phone_Controller_3._0.Activation;
using Phone_Controller_3._0.Contracts.Services;
using Phone_Controller_3._0.Core.Contracts.Services;
using Phone_Controller_3._0.Core.Services;
using Phone_Controller_3._0.Helpers;
using Phone_Controller_3._0.Models;
using Phone_Controller_3._0.Services;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<ScreenMirroringViewModel>();
            services.AddTransient<ScreenMirroringPage>();
            ...
            services.AddTransient<CommandLineViewModel>();
            services.AddTransient<CommandLinePage>();
